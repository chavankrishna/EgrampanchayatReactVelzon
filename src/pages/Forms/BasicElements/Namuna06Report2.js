          ...
          <Row>
            <Col lg={12}>
              <Card>
                ...
                <PreviewCardHeader title="जमा रकमांची नोंदवही" buttonLabel="नवीन माहिती प्रविष्ट करा " onButtonClick={() => navigate("/नमुना-०६")} />
                <CardBody>
                            ...
                            <tr key={index}>
                              ...
                              <td>
                                <div className="d-flex gap-2">
                                  <button className="btn btn-sm btn-success edit-item-btn" onClick={() => navigate("/नमुना-०६-अपडेट", { state: data })}>
                                    एडिट करा
                                  </button>
                                  ...
                                  <button className="btn btn-sm btn-primary remove-item-btn" onClick={() => navigate("/नमुना-०६-पाहणी-पृष्ठ", { state: data })}>
                                    डेटा पाहा
                                  </button>
                                </div>
                              </td>
...
export default Namuna06Report2;
