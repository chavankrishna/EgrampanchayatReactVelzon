  ...
  const handleAddRecord = async () => {
    try {
      ...
      if (response.data) {
        ...
        navigate("/Namuna18Form2"); // Navigate to the '/nikita' route
      }
    } catch (error) {
          ...
          <Row>
            <Col lg={12}>
              <Card>
                ...
                <PreviewCardHeader title="किरकोळ रोकड वही" buttonLabel="नवीन माहिती प्रविष्ट करा " onButtonClick={() => navigate("/Namuna18Form2")} />
                <CardBody>
                            ...
                            <tr key={index}>
                              ...
                              <td>
                                <div className="d-flex gap-2">
                                  <button className="btn btn-sm btn-success edit-item-btn" onClick={() => navigate("/Namuna18Update2", { state: data })}>
                                    एडिट करा
                                  </button>
                                  ...
                                  <button className="btn btn-sm btn-primary remove-item-btn" onClick={() => navigate("/Namuna18View2", { state: data })}>
                                    डेटा पाहा
                                  </button>
                                </div>
                              </td>
                              <td>{data.kharchTarikh}</td>
                              <td>{data.kharchTapshil}</td>

                              <td>{data.konasRakkamDili}</td>

                              <td>{data.kharchRakkam}</td>
                              <td>{data.kharchShera}</td>
                              {/* <td>
                                                                <div className="d-flex gap-2">
...
export default Namuna18Report2;