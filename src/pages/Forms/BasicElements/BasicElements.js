    ...
    return (
        <React.Fragment>
            ...
            <div className="page-content">
                <Container fluid>
                    <BreadCrumb title="नमुना ०२" pageTitle="Forms" />
                      {/* Add the new Breadcrumb here */}
                    ...
                    <Row>
                        <Col lg={12}>
                            <Card>
                                ...
                                <PreviewCardHeader title="माहिती समाविष्ट करा" />
                                <CardBody className="card-body">
                                    
                          
                                    <BreadCrumb title="फॉर्म" pageTitle="कृपया माहिती भरा" />
