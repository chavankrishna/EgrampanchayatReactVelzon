...
const Namuna18Update2 = () => {
    ...
    const handleSubmit = async () => {
        ...
        const requiredFields = [
            'kharchTarikh', 'kharchTapshil', 'konasRakkamDili',
            'kharchRakkam', 'agrimatunKharch',
            'kharchEkun', 'kharchYear', 'kharchShera'
        ];
        ...
        try {
          const response = await axios.post(
            `http://localhost:8080/Namuna18KirkolRokadVahi/update/${formData.id}`,
            formData,
            { headers: { 'Content-Type': 'application/json' } }
        );
            alert('माहिती यशस्वीरीत्या जतन केली गेली आहे');
            navigate('/Namuna18Report2');
        } catch (error) {
                            ...
                            <Card>
                                <CardBody>
                                    ...
                                    {[
                                        ...
                                        { label: " खर्च तारीख", id: "kharchTarikh", type: "date" },
                                          { label: "खर्च तपशील", id: "kharchTapshil" },

  { label: "कोणास रक्कम दिली", id: "konasRakkamDili" },
  { label: "खर्च रक्कम", id: "kharchRakkam" },
  { label: "अग्रिमातून खर्च ", id: "agrimatunKharch" },
  { label: "खर्च एकूण", id: "kharchEkun" },
//   { label: " खर्च वर्ष", id: "jamaEkun" },
      ...
      {field.type === "dropdown" ? (
        ...
        />
                                    ...
                                    <div className="text-start" style={{ marginTop: '20px' }}>
                                        ...
                                        <Button color="danger" onClick={() => navigate('/Namuna18Report2')} style={{ marginLeft: '10px' }}>रद्द करा</Button>
...
export default Namuna18Update2;