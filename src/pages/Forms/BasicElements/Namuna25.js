...
const Namuna25 = () => {
  ...
  const handleSubmit = async () => {
    try {
      ...
      const response = await axios.post(
        "http://localhost:8080/api/guntonukNamuna25/add",
  ...
  const breadcrumbTitle = "२५ - गुंतवणूक वही"; // This could be dynamic
                ...
                <CardBody>
                  ...
                  <div className="col-lg-12">
                    <div className="d-flex justify-content-start button-container">
                      ...
                      <Button color="danger" onClick={() => (window.location.href = "/नमुना-२५-अहवाल")}>
                        रद्द करा
                      </Button>
