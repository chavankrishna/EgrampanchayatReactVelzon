                ...
                <Container fluid>
                    <Row>
                        <Col lg={12}>
                            <Card>
                                {/* <CardHeader>
                                    <h4 className="card-title mb-0">किरकोळ मागणी नोंदवही</h4>
                                </CardHeader> */}
                                <PreviewCardHeader 
                                    title="किरकोळ मागणी नोंदवही" 
                                    buttonLabel="नवीन माहिती प्रविष्ट करा " 
                                    onButtonClick={() => navigate('/Namuna11')} 
                                />
                                <CardBody>
                    ...
                    >
                        काढून टाका
                                                                    ...
                                                                    <button className="btn btn-sm btn-primary remove-item-btn"  onClick={() => navigate('/नमुना-११-पाहणी-पृष्ठ', { state: data })}
                                                                >
                                                                              डेटा पाहा
                                                                     </button> 
                                                                </div>
