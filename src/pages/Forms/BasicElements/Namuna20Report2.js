    ...
    const handleAddRecord = async () => {
        try {
            ...
            if (response.data) {
                ...
                navigate('/Namuna20');  // Navigate to the '/nikita' route
            }
        } catch (error) {
                ...
                <Container fluid>
                    <Row>
                        <Col lg={12}>
                            <Card>
                                {/* <CardHeader>
                                    <h4 className="card-title mb-0">"कामाच्या अंदाजाची नोंदवही"</h4>
                                </CardHeader> */}
                                <PreviewCardHeader 
                                    title="कामाच्या अंदाजाची नोंदवही" 
                                    buttonLabel="नवीन माहिती प्रविष्ट करा " 
                                    onButtonClick={() => navigate('/Namuna20')} 
                                />
                                <CardBody>
                                                        ...
                                                        <tr key={index}>
                                                             ...
                                                             <button
                                                                  className="btn btn-sm btn-success edit-item-btn"
                                                                   onClick={() => navigate('/नमुना-20-अपडेट', { state: data })}
                                                                >
                                                                              एडिट करा
                                                                     </button>                                  
                                                                     <button
                    ...
                    >
                        काढून टाका
                                                                    ...
                                                                    <button className="btn btn-sm btn-primary remove-item-btn"  onClick={() => navigate('/नमुना-२० -पाहणी-पृष्ठ', { state: data })}
                                                                >
                                                                              डेटा पाहा
                                                                     </button> 
                                                                </div>
                                                                ...
                                                                <td>{data.kramank}</td>
                                                            <td>{data.nidhicheShirsh}</td>
                                                            <td>{data.upaShirsh}</td>
                                                            <td>{data.madheHonyachyaSambhavKharchach}</td>
                                                            <td>{data.yanniKelelaAndaj}</td>
                                                            <td>{data.sarvasadharanGoshwaraParinam}</td>
                                                            <td>{data.sarvasadharanGoshwaraBaab}</td>
                                                            <td>{data.sarvasadharanGoshwaraDarRupaye}</td>
                                                            <td>{data.sarvasadharanGoshwaraPratteki}</td>
                                                            <td>{data.sarvasadharanGoshwaraRakkamDashan}</td>
                                                            <td>{data.mojmapAndajpatraKramank}</td>
                                                            <td>{data.mojmapAndajpatraLaambi}</td>
                                                            <td>{data.mojmapAndajpatraRundi}</td>
                                                            <td>{data.mojmapAndajpatraKholi}</td>
                                                            <td>{data.mojmapAndajpatraParimanDashanshat}</td>
                                                            <td>{data.ekun}</td>
                                                            <td>{data.year}</td>
                                                            <td>{data.remark}</td>
                                                            {/* <td>
